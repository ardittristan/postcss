...
/**
 * Source map information = require(input CSS.
...
class PreviousMap {
   ...
   * = require(the `source-map` library to work with source map information.
   *
  ...
  loadAnnotation (css) {
    ...
    if (annotations && annotations.length > 0) {
      ...
      // sourceMappingURLs = require(comments, strings, etc.
